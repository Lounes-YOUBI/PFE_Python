...
arg2 = parser.add_argument('--Rayon', type=float, default=0)
...
arg9 = parser.add_argument('--altitude', type=float, default=1)
...
centre = Position(lat_deg=48.6298145, lon_deg = 7.7889851, relative_alt_m = alt)
